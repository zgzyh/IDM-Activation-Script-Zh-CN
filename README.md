# 提示
原作者已停止维护和更新，故该仓库也无必要继续开放。
# 声明
本人是出于自愿目的进行汉化，并无其他恶意。本工具仅用于免费用途！如有侵权请联系删除。
# 关于Win7可能出现乱码
若Win7执行脚本出现乱码，请使用ANSI版本（别问我为啥不直接用ANSI，ANSI汉化不全，我有强迫症）
# Warning
需要注意⚠️此仓库版本的IAS为汉化版本，本人仅处理cmd文件的汉化内容，仅负责cmd文件中汉化出错的问题，不负责执行过程中出现的问题。原作者仓库[GitHub-IDM Activation Script](https://github.com/WindowsAddict/IDM-Activation-Script)
